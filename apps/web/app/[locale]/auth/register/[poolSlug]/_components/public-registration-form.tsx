          ...
          <div className="grid md:grid-cols-[45%,55%] rounded-2xl overflow-hidden shadow-2xl h-auto md:h-[85vh] md:min-h-[500px] [text-shadow:_2px_2px_4px_rgb(0_0_0_/_40%)]">
            ...
            <div className="p-4 md:p-6 flex flex-col justify-center backdrop-blur-xl bg-white/20 dark:bg-gray-900/20 border-l border-white/20 dark:border-gray-700/50 overflow-y-auto max-h-[calc(100vh-2rem)] md:max-h-[85vh] custom-scrollbar">
              ...
              {heroAssets?.text?.description && (
                <div className="text-sm md:text-xl font-bold text-foreground text-justify mb-2 md:mb-4 line-clamp-5 md:line-clamp-none">
                  {heroAssets.text.description}
                </div>
              )}
              ...
              {heroAssets?.text?.link && (
                <Button variant="link" href={heroAssets.text.link} StartIcon={Sparkles} EndIcon={Sparkles} className="hidden md:flex text-xs md:text-sm mt-2 text-secondary hover:text-foreground">
                  Conoce más en {heroAssets.text.link}
                </Button>
              )}
            </div>
          </div>
